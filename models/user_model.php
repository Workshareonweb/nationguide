...
class User_Model extends Model
{
	...
	{
		return $this->db->select('SELECT u.user_id, u.name, u.username, u.Phone, s.sname, sh.shiftname, sh.time 
									FROM user_table u, station s, shift sh
									WHERE u.StationID = s.stationid AND u.shiftid = sh.shiftid');
	}
