						...
						<div class="col-sm-12">
							<div class="tabbable">
								...
								<div class="tab-content">
                                    ...
                                    <!--box login-->
                                    <div class="box-login">
										<form action="" role="form" id="form_jb" name="form_jb" method="post">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" placeholder="Full/Part time" class="form-control" id="jobname" name="jobname" tabindex="1">
                                                        <input type="hidden" placeholder="" class="form-control" id="jobid" name="jobid" tabindex="3">
													</div>
												</div>
												<div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
														...
														<input type="text" placeholder="Decription" class="form-control" id="job_description" name="job_description" tabindex="2">
													</div>
												</div>
											</div>
