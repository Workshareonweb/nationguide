<script language="javascript" type="text/javascript">
	window.onload = function() {
		document.form_jobposEdit.posname.focus();
	}
</script>
					<!-- end: PAGE HEADER -->
						...
						<div class="col-sm-12">
							<div class="tabbable">
								...
								<div class="tab-content">
                                    ...
                                    <!--box login-->
                                    <div class="box-login">
										<form action="" role="form" id="form_jobposEdit" name="form_jobposEdit" method="post">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" placeholder="មុខតំណែង" class="form-control" id="posname" name="posname" tabindex="1" value="<?php echo $this->jobpostoedit[0]['pos_name'];?>">
												...
												<div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
														...
														<input type="text" placeholder="Decription" class="form-control" id="pos_description" name="pos_description" tabindex="2" value="<?php echo $this->jobpostoedit[0]['pos_des'];?>">
													</div>
												</div>
											</div>
