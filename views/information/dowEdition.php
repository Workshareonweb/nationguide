<script language="javascript" type="text/javascript">
	window.onload = function() {
		document.form_dowEdit.txtdow.focus();
	}
</script>
					<!-- end: PAGE HEADER -->
						...
						<div class="col-sm-12">
							<div class="tabbable">
								...
								<div class="tab-content">
                                    ...
                                    <!--box login-->
                                    <div class="box-login">
										<form action="" role="form" id="form_dowEdit" name="form_dowEdit" method="post">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" placeholder="ថ្ងៃ ធ្វើការ" class="form-control" id="txtdow" name="txtdow" tabindex="1" value="<?php echo $this->dowtoEdit[0]['dow_name'];?>">
                                                        <input type="hidden" placeholder="dowid" class="form-control" id="dowid" name="dowid" tabindex="3"  value="<?php echo $this->dowtoEdit[0]['dowid'];?>">
													</div>
												</div>
												<div class="col-md-8">
                                                    <div class="form-group">
														...
														<input type="text" placeholder="Decription" class="form-control" id="dow_description" name="dow_description" tabindex="2"  value="<?php echo $this->dowtoEdit[0]['dow_des'];?>">
													</div>
												</div>
											</div>
