<script language="javascript" type="text/javascript">
	window.onload = function() {
		document.form_dept.deptname.focus();
	}
</script>
					<!-- end: PAGE HEADER -->
						...
						<div class="col-sm-12">
							<div class="tabbable">
								...
								<div class="tab-content">
                                    ...
                                    <!--box login-->
                                    <div class="box-login">
										<form action="" role="form" id="form_dept" name="form_dept" method="post">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" placeholder="Department Name" class="form-control" id="deptname" name="deptname" tabindex="1">
                                                        <input type="hidden" placeholder="deptid" class="form-control" id="deptid" name="deptid" tabindex="3">
													</div>
												</div>
												<div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
														...
														<input type="text" placeholder="Decription" class="form-control" id="dept_description" name="dept_description" tabindex="2">
													</div>
												</div>
											</div>
